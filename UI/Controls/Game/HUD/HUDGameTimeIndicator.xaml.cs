namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.HUD
{
    ...
    public partial class HUDGameTimeIndicator : BaseUserControl
    {
        ...
        public static readonly DependencyProperty RealTimeTextProperty =
            DependencyProperty.Register(nameof(RealTimeText),
                                        typeof(string),
                                        typeof(HUDGameTimeIndicator),
                                        new PropertyMetadata(default(string)));
        ...
        String realTimeNow = DateTime.Now.ToString("HH:mm:ss");

        public string RealTimeText
        {
            get => (string)this.GetValue(RealTimeTextProperty);
            set => this.SetValue(RealTimeTextProperty, value);
        }
        ...
        private void Update()
        {
            ...
            this.RealTimeText = DateTime.Now.ToString("HH:mm:ss");
        }
    }
}